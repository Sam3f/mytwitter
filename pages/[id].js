...
function PostPage({ providers }) {
  ...
  //if there is no session I want to get my login component
  ...
  return (
    <div className={styles.container}>
      ...
      <main className="bg-gray-900 min-h-screen flex max-w-[1500px] mx-auto">
        <Sidebar />
        <div className="flex-grow border-l border-r border-gray-700 max-w-2xl sm:ml-[73px] xl:ml-[370px] width-[40px]">
          <div
